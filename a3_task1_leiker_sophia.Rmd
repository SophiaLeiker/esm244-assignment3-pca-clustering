...
world_clean <- world %>% 
  ...
  drop_na() #%>% 
  #rename( "Tree_Canopy_Cover_%" = tree_canopy_cover)
```
...
**Figure 1**: Biplot illustrating the eigenvalues (loading variables) for principal component 1 and principal component 2. The color scale represents tree canopy cover with orange drots representing points with low levels of tree canopy cover and forest green representing higher levels of tree canopy cover
